...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'ProjetBDDGeneralBundle' => 'ProjetBDD\\GeneralBundle\\ProjetBDDGeneralBundle',
                'ProjetBDDAdminBundle' => 'ProjetBDD\\AdminBundle\\ProjetBDDAdminBundle',
            ...
            'locale' => 'en',
            'secret' => 'f4a0d130e81099fae27c432bf3066945f',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'f4a0d130e81099fae27c432bf3066945f',
        ...
        $this->methodMap = array(
            ...
            'projetbdd.crud.concept' => 'getProjetbdd_Crud_ConceptService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'oci8', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'xe', 'user' => 'ProjetBDD', 'password' => 'pass', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\ProjetBDD\\GeneralBundle\\Entity'))), 'ProjetBDD\\GeneralBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ProjetBDDGeneralBundle' => 'ProjetBDD\\GeneralBundle\\Entity'));
        ...
        $b->setProxyDir('C:/wamp/www/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'projetbdd.crud.concept' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ProjetBDD\Generalbundle\CRUD\CrudConcept A ProjetBDD\Generalbundle\CRUD\CrudConcept instance.
     */
    protected function getProjetbdd_Crud_ConceptService()
    {
        return $this->services['projetbdd.crud.concept'] = new \ProjetBDD\Generalbundle\CRUD\CrudConcept();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\ProjetBDD\\GeneralBundle/Resources/views'), 'ProjetBDDGeneral');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\ProjetBDD\\AdminBundle/Resources/views'), 'ProjetBDDAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f4a0d130e81099fae27c432bf3066945f');
    }
